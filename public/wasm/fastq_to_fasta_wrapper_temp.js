/**
 * Wrapper function for the fastq_to_fasta WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqToFasta tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_to_fasta.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqToFasta(inputData, args = []) {
    console.log("Starting runFastqToFasta with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_to_fasta');
      const moduleFactory = window['fastq_to_fasta'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_to_fasta is not available.");
      }
      ...
      console.error('Error in runFastqToFasta:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqToFasta function globally.
   */
  window.run_fastq_to_fasta = runFastqToFasta;
})();