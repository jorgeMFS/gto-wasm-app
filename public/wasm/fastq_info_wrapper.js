/**
 * Wrapper function for the fastq_info WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqInfo tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_info.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqInfo(inputData, args = []) {
    console.log("Starting runFastqInfo with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_info');
      const moduleFactory = window['fastq_info'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_info is not available.");
      }
      ...
      console.error('Error in runFastqInfo:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqInfo function globally.
   */
  window.run_fastq_info = runFastqInfo;
})();