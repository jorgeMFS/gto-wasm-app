/**
 * Wrapper function for the fastq_unpack WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqUnpack tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_unpack.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqUnpack(inputData, args = []) {
    console.log("Starting runFastqUnpack with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_unpack');
      const moduleFactory = window['fastq_unpack'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_unpack is not available.");
      }
      ...
      console.error('Error in runFastqUnpack:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqUnpack function globally.
   */
  window.run_fastq_unpack = runFastqUnpack;
})();