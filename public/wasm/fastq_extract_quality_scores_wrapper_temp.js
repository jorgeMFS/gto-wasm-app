/**
 * Wrapper function for the fastq_extract_quality_scores WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqExtractQualityScores tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_extract_quality_scores.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqExtractQualityScores(inputData, args = []) {
    console.log("Starting runFastqExtractQualityScores with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_extract_quality_scores',
      ...
      // Load the module
      await loadModuleScript('fastq_extract_quality_scores');
      const moduleFactory = window['fastq_extract_quality_scores'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_extract_quality_scores is not available.");
      }
      ...
      console.error('Error in runFastqExtractQualityScores:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqExtractQualityScores function globally.
   */
  window.run_fastq_extract_quality_scores = runFastqExtractQualityScores;
})();