/**
 * Wrapper function for the filter WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the Filter tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to filter.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFilter(inputData, args = []) {
    console.log("Starting runFilter with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('filter');
      const moduleFactory = window['filter'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for filter is not available.");
      }
      ...
      console.error('Error in runFilter:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFilter function globally.
   */
  window.run_filter = runFilter;
})();