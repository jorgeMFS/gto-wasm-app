/**
 * Wrapper function for the fasta_find_n_pos WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaFindNPos tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_find_n_pos.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaFindNPos(inputData, args = []) {
    console.log("Starting runFastaFindNPos with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_find_n_pos');
      const moduleFactory = window['fasta_find_n_pos'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_find_n_pos is not available.");
      }
      ...
      console.error('Error in runFastaFindNPos:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaFindNPos function globally.
   */
  window.run_fasta_find_n_pos = runFastaFindNPos;
})();