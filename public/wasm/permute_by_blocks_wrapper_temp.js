/**
 * Wrapper function for the permute_by_blocks WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the PermuteByBlocks tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to permute_by_blocks.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runPermuteByBlocks(inputData, args = []) {
    console.log("Starting runPermuteByBlocks with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('permute_by_blocks');
      const moduleFactory = window['permute_by_blocks'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for permute_by_blocks is not available.");
      }
      ...
      console.error('Error in runPermuteByBlocks:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runPermuteByBlocks function globally.
   */
  window.run_permute_by_blocks = runPermuteByBlocks;
})();