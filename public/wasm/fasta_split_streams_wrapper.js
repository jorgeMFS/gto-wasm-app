...
(function() {
  /**
   * Runs the FastaSplitStreams tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_split_streams.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaSplitStreams(inputData, args = []) {
    console.log("Starting runFastaSplitStreams with input:", inputData);
    ...
    try {
      ...
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_split_streams is not available.");
      }
  ...
  /**
   * Expose the runFastaSplitStreams function globally.
   */
