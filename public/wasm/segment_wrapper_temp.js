/**
 * Wrapper function for the segment WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the Segment tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to segment.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runSegment(inputData, args = []) {
    console.log("Starting runSegment with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('segment');
      const moduleFactory = window['segment'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for segment is not available.");
      }
      ...
      console.error('Error in runSegment:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runSegment function globally.
   */
  window.run_segment = runSegment;
})();