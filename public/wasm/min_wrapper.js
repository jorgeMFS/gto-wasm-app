...
(function() {
  /**
   * Runs the Min tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to min.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runMin(inputData, args = []) {
    console.log("Starting runMin with input:", inputData);
    ...
    try {
      ...
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for min is not available.");
      }
  ...
  /**
   * Expose the runMin function globally.
   */
