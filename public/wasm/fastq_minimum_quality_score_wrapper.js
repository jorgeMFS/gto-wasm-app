/**
 * Wrapper function for the fastq_minimum_quality_score WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqMinimumQualityScore tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_minimum_quality_score.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqMinimumQualityScore(inputData, args = []) {
    console.log("Starting runFastqMinimumQualityScore with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_minimum_quality_score',
      ...
      // Load the module
      await loadModuleScript('fastq_minimum_quality_score');
      const moduleFactory = window['fastq_minimum_quality_score'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_minimum_quality_score is not available.");
      }
      ...
      console.error('Error in runFastqMinimumQualityScore:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqMinimumQualityScore function globally.
   */
  window.run_fastq_minimum_quality_score = runFastqMinimumQualityScore;
})();