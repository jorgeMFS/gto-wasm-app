/**
 * Wrapper function for the fastq_complement WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqComplement tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_complement.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqComplement(inputData, args = []) {
    console.log("Starting runFastqComplement with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_complement');
      const moduleFactory = window['fastq_complement'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_complement is not available.");
      }
      ...
      console.error('Error in runFastqComplement:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqComplement function globally.
   */
  window.run_fastq_complement = runFastqComplement;
})();