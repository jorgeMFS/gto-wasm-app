/**
 * Wrapper function for the fasta_extract_pattern_coords WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaExtractPatternCoords tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_extract_pattern_coords.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaExtractPatternCoords(inputData, args = []) {
    console.log("Starting runFastaExtractPatternCoords with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fasta_extract_pattern_coords',
      ...
      // Load the module
      await loadModuleScript('fasta_extract_pattern_coords');
      const moduleFactory = window['fasta_extract_pattern_coords'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_extract_pattern_coords is not available.");
      }
      ...
      console.error('Error in runFastaExtractPatternCoords:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaExtractPatternCoords function globally.
   */
  window.run_fasta_extract_pattern_coords = runFastaExtractPatternCoords;
})();