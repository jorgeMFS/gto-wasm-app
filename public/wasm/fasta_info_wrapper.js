...
(function() {
  /**
   * Runs the FastaInfo tool with the provided input data.
  ...
  async function runFastaInfo(inputData, args = []) {
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_info');
      const moduleFactory = window['fasta_info'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_info is not available.");
      }
