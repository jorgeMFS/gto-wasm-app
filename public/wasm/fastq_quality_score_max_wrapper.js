/**
 * Wrapper function for the fastq_quality_score_max WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqQualityScoreMax tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_quality_score_max.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqQualityScoreMax(inputData, args = []) {
    console.log("Starting runFastqQualityScoreMax with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_quality_score_max',
      ...
      // Load the module
      await loadModuleScript('fastq_quality_score_max');
      const moduleFactory = window['fastq_quality_score_max'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_quality_score_max is not available.");
      }
      ...
      console.error('Error in runFastqQualityScoreMax:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqQualityScoreMax function globally.
   */
  window.run_fastq_quality_score_max = runFastqQualityScoreMax;
})();