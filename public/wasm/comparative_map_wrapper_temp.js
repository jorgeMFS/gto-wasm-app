/**
 * Wrapper function for the comparative_map WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the ComparativeMap tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to comparative_map.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runComparativeMap(inputData, args = []) {
    console.log("Starting runComparativeMap with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('comparative_map');
      const moduleFactory = window['comparative_map'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for comparative_map is not available.");
      }
      ...
      console.error('Error in runComparativeMap:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runComparativeMap function globally.
   */
  window.run_comparative_map = runComparativeMap;
})();