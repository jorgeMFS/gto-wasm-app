...
(function() {
  /**
   * Runs the FastaRandExtraChars tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_rand_extra_chars.
  ...
  async function runFastaRandExtraChars(inputData, args = []) {
    console.log("Starting runFastaRandExtraChars with input:", inputData);
    ...
    try {
      ...
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_rand_extra_chars is not available.");
      }
  ...
  /**
   * Expose the runFastaRandExtraChars function globally.
   */
