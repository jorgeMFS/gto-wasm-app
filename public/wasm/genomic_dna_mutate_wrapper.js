/**
 * Wrapper function for the genomic_dna_mutate WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the GenomicDnaMutate tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to genomic_dna_mutate.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runGenomicDnaMutate(inputData, args = []) {
    console.log("Starting runGenomicDnaMutate with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './genomic_dna_mutate',
      ...
      // Load the module
      await loadModuleScript('genomic_dna_mutate');
      const moduleFactory = window['genomic_dna_mutate'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for genomic_dna_mutate is not available.");
      }
      ...
      console.error('Error in runGenomicDnaMutate:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runGenomicDnaMutate function globally.
   */
  window.run_genomic_dna_mutate = runGenomicDnaMutate;
})();