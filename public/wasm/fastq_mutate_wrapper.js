/**
 * Wrapper function for the fastq_mutate WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqMutate tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_mutate.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqMutate(inputData, args = []) {
    console.log("Starting runFastqMutate with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_mutate');
      const moduleFactory = window['fastq_mutate'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_mutate is not available.");
      }
      ...
      console.error('Error in runFastqMutate:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqMutate function globally.
   */
  window.run_fastq_mutate = runFastqMutate;
})();