/**
 * Wrapper function for the genomic_complement WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the GenomicComplement tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to genomic_complement.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runGenomicComplement(inputData, args = []) {
    console.log("Starting runGenomicComplement with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './genomic_complement',
      ...
      // Load the module
      await loadModuleScript('genomic_complement');
      const moduleFactory = window['genomic_complement'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for genomic_complement is not available.");
      }
      ...
      console.error('Error in runGenomicComplement:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runGenomicComplement function globally.
   */
  window.run_genomic_complement = runGenomicComplement;
})();