/**
 * Wrapper function for the fastq_pack WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqPack tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_pack.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqPack(inputData, args = []) {
    console.log("Starting runFastqPack with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_pack');
      const moduleFactory = window['fastq_pack'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_pack is not available.");
      }
      ...
      console.error('Error in runFastqPack:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqPack function globally.
   */
  window.run_fastq_pack = runFastqPack;
})();