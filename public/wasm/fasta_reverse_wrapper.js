/**
 * Wrapper function for the fasta_reverse WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaReverse tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_reverse.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaReverse(inputData, args = []) {
    console.log("Starting runFastaReverse with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_reverse');
      const moduleFactory = window['fasta_reverse'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_reverse is not available.");
      }
      ...
      console.error('Error in runFastaReverse:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaReverse function globally.
   */
  window.run_fasta_reverse = runFastaReverse;
})();