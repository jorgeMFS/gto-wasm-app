/**
 * Wrapper function for the fastq_quality_score_min WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqQualityScoreMin tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_quality_score_min.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqQualityScoreMin(inputData, args = []) {
    console.log("Starting runFastqQualityScoreMin with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_quality_score_min',
      ...
      // Load the module
      await loadModuleScript('fastq_quality_score_min');
      const moduleFactory = window['fastq_quality_score_min'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_quality_score_min is not available.");
      }
      ...
      console.error('Error in runFastqQualityScoreMin:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqQualityScoreMin function globally.
   */
  window.run_fastq_quality_score_min = runFastqQualityScoreMin;
})();