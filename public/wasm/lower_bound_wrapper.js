...
(function() {
  /**
   * Runs the LowerBound tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to lower_bound.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runLowerBound(inputData, args = []) {
    console.log("Starting runLowerBound with input:", inputData);
    ...
    try {
      ...
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for lower_bound is not available.");
      }
  ...
  /**
   * Expose the runLowerBound function globally.
   */
