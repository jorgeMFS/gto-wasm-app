...
(function() {
  /**
   * Runs the FastaMergeStreams tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_merge_streams.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaMergeStreams(inputData, args = []) {
    console.log("Starting runFastaMergeStreams with input:", inputData);
    ...
    try {
      ...
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_merge_streams is not available.");
      }
  ...
  /**
   * Expose the runFastaMergeStreams function globally.
   */
