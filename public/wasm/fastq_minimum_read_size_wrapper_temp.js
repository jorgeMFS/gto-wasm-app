/**
 * Wrapper function for the fastq_minimum_read_size WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqMinimumReadSize tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_minimum_read_size.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqMinimumReadSize(inputData, args = []) {
    console.log("Starting runFastqMinimumReadSize with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_minimum_read_size',
      ...
      // Load the module
      await loadModuleScript('fastq_minimum_read_size');
      const moduleFactory = window['fastq_minimum_read_size'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_minimum_read_size is not available.");
      }
      ...
      console.error('Error in runFastqMinimumReadSize:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqMinimumReadSize function globally.
   */
  window.run_fastq_minimum_read_size = runFastqMinimumReadSize;
})();