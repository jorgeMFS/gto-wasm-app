/**
 * Wrapper function for the fastq_exclude_n WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqExcludeN tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_exclude_n.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqExcludeN(inputData, args = []) {
    console.log("Starting runFastqExcludeN with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_exclude_n');
      const moduleFactory = window['fastq_exclude_n'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_exclude_n is not available.");
      }
      ...
      console.error('Error in runFastqExcludeN:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqExcludeN function globally.
   */
  window.run_fastq_exclude_n = runFastqExcludeN;
})();