/**
 * Wrapper function for the fasta_to_seq WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaToSeq tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_to_seq.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaToSeq(inputData, args = []) {
    console.log("Starting runFastaToSeq with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_to_seq');
      const moduleFactory = window['fasta_to_seq'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_to_seq is not available.");
      }
      ...
      console.error('Error in runFastaToSeq:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaToSeq function globally.
   */
  window.run_fasta_to_seq = runFastaToSeq;
})();