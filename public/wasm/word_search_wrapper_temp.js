/**
 * Wrapper function for the word_search WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the WordSearch tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to word_search.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runWordSearch(inputData, args = []) {
    console.log("Starting runWordSearch with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('word_search');
      const moduleFactory = window['word_search'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for word_search is not available.");
      }
      ...
      console.error('Error in runWordSearch:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runWordSearch function globally.
   */
  window.run_word_search = runWordSearch;
})();