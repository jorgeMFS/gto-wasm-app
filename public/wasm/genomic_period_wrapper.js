/**
 * Wrapper function for the genomic_period WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the GenomicPeriod tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to genomic_period.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runGenomicPeriod(inputData, args = []) {
    console.log("Starting runGenomicPeriod with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('genomic_period');
      const moduleFactory = window['genomic_period'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for genomic_period is not available.");
      }
      ...
      console.error('Error in runGenomicPeriod:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runGenomicPeriod function globally.
   */
  window.run_genomic_period = runGenomicPeriod;
})();