/**
 * Wrapper function for the genomic_extract WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the GenomicExtract tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to genomic_extract.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runGenomicExtract(inputData, args = []) {
    console.log("Starting runGenomicExtract with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('genomic_extract');
      const moduleFactory = window['genomic_extract'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for genomic_extract is not available.");
      }
      ...
      console.error('Error in runGenomicExtract:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runGenomicExtract function globally.
   */
  window.run_genomic_extract = runGenomicExtract;
})();