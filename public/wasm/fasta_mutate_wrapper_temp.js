/**
 * Wrapper function for the fasta_mutate WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaMutate tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_mutate.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaMutate(inputData, args = []) {
    console.log("Starting runFastaMutate with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_mutate');
      const moduleFactory = window['fasta_mutate'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_mutate is not available.");
      }
      ...
      console.error('Error in runFastaMutate:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaMutate function globally.
   */
  window.run_fasta_mutate = runFastaMutate;
})();