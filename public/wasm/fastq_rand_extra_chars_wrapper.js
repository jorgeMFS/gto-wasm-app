/**
 * Wrapper function for the fastq_rand_extra_chars WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqRandExtraChars tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_rand_extra_chars.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqRandExtraChars(inputData, args = []) {
    console.log("Starting runFastqRandExtraChars with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fastq_rand_extra_chars',
      ...
      // Load the module
      await loadModuleScript('fastq_rand_extra_chars');
      const moduleFactory = window['fastq_rand_extra_chars'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_rand_extra_chars is not available.");
      }
      ...
      console.error('Error in runFastqRandExtraChars:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqRandExtraChars function globally.
   */
  window.run_fastq_rand_extra_chars = runFastqRandExtraChars;
})();