/**
 * Wrapper function for the fasta_extract WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaExtract tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_extract.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaExtract(inputData, args = []) {
    console.log("Starting runFastaExtract with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_extract');
      const moduleFactory = window['fasta_extract'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_extract is not available.");
      }
      ...
      console.error('Error in runFastaExtract:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaExtract function globally.
   */
  window.run_fasta_extract = runFastaExtract;
})();