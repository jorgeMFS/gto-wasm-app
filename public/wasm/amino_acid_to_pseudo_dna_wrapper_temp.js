/**
 * Wrapper function for the amino_acid_to_pseudo_dna WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the AminoAcidToPseudoDna tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to amino_acid_to_pseudo_dna.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runAminoAcidToPseudoDna(inputData, args = []) {
    console.log("Starting runAminoAcidToPseudoDna with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './amino_acid_to_pseudo_dna',
      ...
      // Load the module
      await loadModuleScript('amino_acid_to_pseudo_dna');
      const moduleFactory = window['amino_acid_to_pseudo_dna'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for amino_acid_to_pseudo_dna is not available.");
      }
      ...
      console.error('Error in runAminoAcidToPseudoDna:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runAminoAcidToPseudoDna function globally.
   */
  window.run_amino_acid_to_pseudo_dna = runAminoAcidToPseudoDna;
})();