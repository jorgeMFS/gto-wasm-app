/**
 * Wrapper function for the fastq_from_seq WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqFromSeq tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_from_seq.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqFromSeq(inputData, args = []) {
    console.log("Starting runFastqFromSeq with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_from_seq');
      const moduleFactory = window['fastq_from_seq'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_from_seq is not available.");
      }
      ...
      console.error('Error in runFastqFromSeq:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqFromSeq function globally.
   */
  window.run_fastq_from_seq = runFastqFromSeq;
})();