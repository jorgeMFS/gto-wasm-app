/**
 * Wrapper function for the fasta_complement WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaComplement tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_complement.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaComplement(inputData, args = []) {
    console.log("Starting runFastaComplement with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fasta_complement');
      const moduleFactory = window['fasta_complement'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_complement is not available.");
      }
      ...
      console.error('Error in runFastaComplement:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaComplement function globally.
   */
  window.run_fasta_complement = runFastaComplement;
})();