/**
 * Wrapper function for the new_line_on_new_x WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the NewLineOnNewX tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to new_line_on_new_x.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runNewLineOnNewX(inputData, args = []) {
    console.log("Starting runNewLineOnNewX with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('new_line_on_new_x');
      const moduleFactory = window['new_line_on_new_x'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for new_line_on_new_x is not available.");
      }
      ...
      console.error('Error in runNewLineOnNewX:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runNewLineOnNewX function globally.
   */
  window.run_new_line_on_new_x = runNewLineOnNewX;
})();