/**
 * Wrapper function for the fastq_to_mfasta WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqToMfasta tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_to_mfasta.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqToMfasta(inputData, args = []) {
    console.log("Starting runFastqToMfasta with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_to_mfasta');
      const moduleFactory = window['fastq_to_mfasta'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_to_mfasta is not available.");
      }
      ...
      console.error('Error in runFastqToMfasta:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqToMfasta function globally.
   */
  window.run_fastq_to_mfasta = runFastqToMfasta;
})();