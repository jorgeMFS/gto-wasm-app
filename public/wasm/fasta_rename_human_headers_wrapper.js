/**
 * Wrapper function for the fasta_rename_human_headers WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastaRenameHumanHeaders tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fasta_rename_human_headers.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastaRenameHumanHeaders(inputData, args = []) {
    console.log("Starting runFastaRenameHumanHeaders with input:", inputData);
    ...
    try {
      ...
      const options = {
        ...
        thisProgram: './fasta_rename_human_headers',
      ...
      // Load the module
      await loadModuleScript('fasta_rename_human_headers');
      const moduleFactory = window['fasta_rename_human_headers'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fasta_rename_human_headers is not available.");
      }
      ...
      console.error('Error in runFastaRenameHumanHeaders:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastaRenameHumanHeaders function globally.
   */
  window.run_fasta_rename_human_headers = runFastaRenameHumanHeaders;
})();