/**
 * Wrapper function for the fastq_reverse WASM module.
 * Automatically generated by generate_wrapper.py
 */

(function() {
  /**
   * Runs the FastqReverse tool with the provided input data.
   * @param {string} inputData - The input data.
   * @param {Array<string>} args - Additional arguments to pass to fastq_reverse.
   * @returns {Promise<Object>} An object containing stdout and stderr outputs.
   */
  async function runFastqReverse(inputData, args = []) {
    console.log("Starting runFastqReverse with input:", inputData);
    ...
    try {
      ...
      // Load the module
      await loadModuleScript('fastq_reverse');
      const moduleFactory = window['fastq_reverse'];
      if (typeof moduleFactory !== 'function') {
        throw new Error("Module factory function for fastq_reverse is not available.");
      }
      ...
      console.error('Error in runFastqReverse:', err);
      throw err;
    }
  }
  ...
  /**
   * Expose the runFastqReverse function globally.
   */
  window.run_fastq_reverse = runFastqReverse;
})();